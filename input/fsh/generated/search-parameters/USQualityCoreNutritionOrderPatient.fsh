...
Instance: us-quality-core-nutrition-order-patient
InstanceOf: SearchParameter
Usage: #definition
* url = "http://hl7.org/fhir/us/quality-core/SearchParameter/us-quality-core-nutrition-order-patient"
* version = "1.0.0"
* name = "USQualityCoreNutritionOrderPatient"
* status = #active
* date = "2026-06-30"
...
* description = "US Quality Core NutritionOrder patient Search Parameter"
* code = #patient
* base[0] = #NutritionOrder
* type = #reference
