...
Instance: us-quality-core-patient-id
InstanceOf: SearchParameter
Usage: #definition
* url = "http://hl7.org/fhir/us/quality-core/SearchParameter/us-quality-core-patient-id"
* version = "1.0.0"
* name = "USQualityCorePatientId"
* status = #active
* date = "2026-06-30"
...
* description = "US Quality Core Patient _id Search Parameter"
* code = #_id
* base[0] = #Patient
* type = #token
